$(document).ready(function(){   
    ...
    var slider = document.getElementById("myStandardRange");

    var output = document.getElementById("standard-demo");

    var down_payment_output = document.getElementById("standard-down-payment");
    ...
    slider.oninput = function() {
        ...
        $('.std-percentage-container').html(percentage_val + "%");

        if(percentage_val == 20){
            $('#std-alt-mortgage-period').html(18 + ' Years');
            $('#btl-repayment-period').val(18);
        }else if(percentage_val == 30){
            $('#std-alt-mortgage-period').html(15 + ' Years');
            $('#btl-repayment-period').val(15);
        }else if(percentage_val == 40){
            $('#std-alt-mortgage-period').html(12 + ' Years');
            $('#btl-repayment-period').val(12);
        }else if(percentage_val == 50){
            $('#std-alt-mortgage-period').html(10 + ' Years');
