...
class Buytolet extends CI_Controller {
	...
	public function signupForm(){
		...
		if(!$email_res){
			...
			if($registration){    
                ...
                $formatted_subject = $this->plusify_string($subject);
                
				//Successful insert then send email to user
				$this->send_personalized_email($formatted_subject, $email, 'verification', $data['confirmationLink'], $lname);
				
				$notificationDataSentToDb = $this->buytolet_model->insertNotification('SmallSmall Confirmation', $messageR, $userID, $fname);
	...
	public function resetForm(){
	    ...
	    if($response){
	        ...
	        $subject = $this->plusify_string('Password Reset Instruction');
	        
	        $this->send_personalized_email($subject, $username, 'password-reset', $data['resetLink']);
	...
	public function updatePayment(){
		...
		$email_subject = $this->plusify_string("Payment Successful");
		
		$user_name = $this->plusify_string($name);
