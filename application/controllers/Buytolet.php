...
class Buytolet extends CI_Controller
{
	...
	public function send_payment_email($subject, $email, $property_name, $shares_amount, $name, $amount)
	{
		...
		$method = 'https://api.selzy.com/en/api/sendEmail?format=json&api_key=6tkb5syz5g1bgtkz1uonenrxwpngrwpq9za1u6ha&email=' . $email . '&sender_name=Buy+Small+Small&sender_email=hello@buysmallsmall.ng&subject=Sample+Subject&body=' . $body . '&list_id=323';
	...
	public function self_shares_email($subject, $email, $shares_amount, $property_name, $amount, $completion_date, $buyback_rate, $hold_period, $migration_date, $name)
	{
		...
		$method = 'https://api.selzy.com/en/api/sendEmail?format=json&api_key=6tkb5syz5g1bgtkz1uonenrxwpngrwpq9za1u6ha&email=' . $email . '&sender_name=Buy+Small+Small&sender_email=hello@buysmallsmall.ng&subject=' . $subject . '&body=' . $body . '&list_id=323';
	...
	public function send_personalized_email($subject, $email, $email_type, $link, $name = '')
	{
		...
		if ($email_type == 'verification') {
			...
			$method = 'https://api.selzy.com/en/api/subscribe?format=json&api_key=6tkb5syz5g1bgtkz1uonenrxwpngrwpq9za1u6ha&list_ids=323&fields[email]=' . $email . '&fields[Name]=' . $name . '&double_optin=3&overwrite=0';
	...
	public function test_email()
	{
		...
		$subscribe = 'https://api.selzy.com/en/api/subscribe?format=json&api_key=6tkb5syz5g1bgtkz1uonenrxwpngrwpq9za1u6ha&list_ids=323&fields[email]=seuncrowther@gmail.com&fields[Name]=Oluwaseun+Crowther&double_optin=0&overwrite=0';
