						...
						<a href="<?php echo base_url() . "co-own/" . $pool_value['propertyID']; ?>" class="home-card">
							...
							<div class="bottom-section">
								...
								<ul>
									...
									<li>&bullet; <?php if (@$pool_value['property_size']) {
														echo number_format($pool_value['property_size']);
													} else {
														echo 0;
													} ?> sqm</li>
								</ul>
								<div class="key-values">
									...
									<!---<div>
											...
											<h3><?php //echo number_format($pool_value['available_units']); 
												?></h3>
										</div>--->
						...
						<a href="<?php echo base_url() . "property/" . $value['propertyID']; ?>" class="home-card">
							...
							<div class="bottom-section">
								...
								<ul>
									...
									<li>&bullet; <?php if (@$value['property_size']) {
														echo number_format($value['property_size']);
													} else {
														echo 0;
													} ?> sqm</li>
								</ul>
...
></script> -->
	...
	<div class="partner-wrapper">
		...
		<div class="partner-logo-container">
			...
			<!---<div class="partner-logo-item"><img src="<?php //echo base_url('assets/img/asymmetry-ventures-logo.png'); 
															?>" alt="Asymmetry ventures logo" /></div>
