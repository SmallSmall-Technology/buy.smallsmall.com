    ...
    <div class="property-left-section">
        ...
        <div class="property-left-word-sect">
            ...
            <div class="property-props">
                ...
                <p>&bullet; <?php if (@$property['property_size']) {
                ...
                <table cellpadding="5" class="highlight-tbl">
                    ...
                    <tr>
                        <th>
                            ...
                            <div class="tooltip"><i class="fa fa-info"></i>
                                <span class="tooltiptext">
                                    Total buyback rate at the end of hold period
                                </span>
                            </div>
                        </th>
                        <td>
                    ...
                    <tr>
                        <th>
                            ...
                            <div class="tooltip"><i class="fa fa-info"></i>
                                <span class="tooltiptext">
                                    Capital plus buyback rate accrued year over year(YoY) up to hold period.
                                </span>
                        </th>
                        <td>
        ...
        <div class="features_description">
            ...
            <div class="payment-box payment-boxes mortgage-finance-payment">
                ...
                <div style="display:block; margin-bottom:15px;text-align:center"><h3 class="price" id="unit-demo"><?php echo round((100 / $property['pool_units']), 2); ?>%</h3></div>
                <!---- Range selector ---->
                ...
                <div class="financing-options-sect">
                    ...
                    <div class="option-list3">
                        ...
                        <div class="finance-right-options">
                            <div>
                                <div class="total_desc finance-numbers" id="total-output"><span style="font-family:helvetica;">&#x20A6;</span><?php //echo number_format($property['price'] + ($property['price'])); 
                                                                                                                                                ?></div>
                            </div>
                        </div>
                    </div>
...
<input type="hidden" id="target-option" value="<?php echo @$targetOption; ?>" />
...
<!---<script src="<?php //echo base_url('asset/js/financial-highlights.js'); 
                    ?>"></script>--->
