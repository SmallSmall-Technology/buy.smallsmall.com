          ...
          <div class="row">
            ...
            <div class="col-md-6 col-12m d-flex align-items-center">
              <div class="d-flex flex-wrap">
                <button class="btn stp-btn mb-2 mr-2">Modify <img class="img-fluid" src="<?php echo base_url() ?>assets/user-assets/images/modify-stp.svg"
                    alt="">
                </button>
                <button class="btn stp-btn mb-2 mr-2">Pause <img class="img-fluid" src="<?php echo base_url() ?>assets/user-assets/images/pause-stp.svg"
                    alt="">
                </button>
                <button class="btn stp-btn mb-2 mr-2" style="color: #662D91">Activate <img class="img-fluid"
                    src="<?php echo base_url() ?>assets/user-assets/images/power-stp.svg" alt="">
                </button>
                <button class="btn stp-btn mb-2 mr-2">Cancel <img class="img-fluid" src="<?php echo base_url() ?>assets/user-assets/images/cross-stp.svg"
                    alt="">
                </button>
              </div>
