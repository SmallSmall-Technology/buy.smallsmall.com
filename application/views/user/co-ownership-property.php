      ...
      <div class="col-12 mt-5 collapse show" id="property">
        <div class="primary-background p-md-5 p-3">
          ...
          <div class="row mt-4">
            ...
            <div class="col-md-3 col-12">
              <button class="btn font-weight-light w-100 p-md-3 p-2 tertiary-background btn-custom-tertiary"
                type="button">
                Request Buyback gain</button>
            </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body px-5">
                    <p class="text-center my-4">You have &nbsp;&nbsp;<span
                        style="font-size: 26px;"><?php echo $co_details['unit_amount']; ?></span>&nbsp;&nbsp;Property
                      shares</p>
                    <form id="giftBasket">
            ...
            <div class="modal fade" id="transferShares" data-backdrop="static" data-keyboard="false" tabindex="-1"
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body px-5">
                    <p class="text-center my-4">You have &nbsp;&nbsp;<span
                        style="font-size: 26px;"><?php echo $co_details['unit_amount']; ?></span>&nbsp;&nbsp;Property shares</p>
                    <form id="transferShares">
                      ...
                      <div class="my-4 text-center mt-5">
                        <button type="submit" id="transfer-but" class="btn btn-dark py-2 btn-custom-primary px-5" data-toggle="modal"
