		...
		<div style="width:90%;font-family:calibri;padding:20px 0;margin:auto;">
            ...
            <table width="100%">
				...
				<tr style="background:#f2f2f2">
					<td valign="top" style="text-align:left;line-height:30px" valign="top" width="50%"><b style="color:#007DC1">Time of inspection :</b></td>
					<td valign="top" style="text-align:left;line-height:30px" valign="top"><?php echo $inspectionTime; ?></td>
				</tr>
				<tr>
					<td valign="top" style="text-align:left;line-height:30px" valign="top" width="50%"><b style="color:#007DC1">Type of inspection :</b></td>
					<td valign="top" style="text-align:left;line-height:30px" valign="top">Physical<?php //echo $inspectionType; ?></td>
				</tr>
			</table>
