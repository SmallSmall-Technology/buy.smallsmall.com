...
<!-- 					<a class="link-text" target="_blank" href="https://stay.smallsmall.com">Nightly stay</a> -->
					...
					<a class="link-text" href="<?php echo base_url('https://edap.buysmallsmall.ng/'); ?>">Property Developer</a>
					<a class="link-text" href="<?php echo base_url('https://asapp.smallsmall.com/program'); ?>">Sales agent</a>
